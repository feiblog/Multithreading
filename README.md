...
> 描述如何不适用内核模型的方式来使线程等待。<br/>
> 另外，我们介绍了SpinWait，它是一个混合同步构造，<br/>
> 被设计为使用用户模式等待一段时间，然后切换到内核模式以节省CPU时间


## <span id="Chapter3">第三章 使用线程池</span>
...
> 展示在线程池中如何一步的执行委托。<br/>
> 另外，我们将讨论一个叫做`异步编程模型(Asynchronous Programming Modek,简称APM)`的方式，这是.NET历史中第一个异步编程模式。
...
> `SpinWait` https://www.cnblogs.com/xtt321/p/13864805.html
<br/>
<br/>
<br/>
<br/>
